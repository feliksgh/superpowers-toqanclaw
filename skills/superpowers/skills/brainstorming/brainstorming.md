---
name: brainstorming
description: Use before any creative work — creating features, building components, adding functionality, or modifying behavior. Explores user intent, requirements, and design before any implementation. Trigger phrases include "build", "create", "add", "implement", "design", or any request describing new functionality.
---
...
5. **Write design doc** — save to `data/<project-slug>/specs/YYYY-MM-DD-<topic>-design.md` and commit
6. **Spec self-review** — quick inline check for placeholders, contradictions, ambiguity, scope (see below)
7. **User reviews written spec** — ask your human partner to review the spec file before proceeding
8. **Transition to implementation** — read the `writing-plans` skill to create an implementation plan
...
User reviews spec? → changes requested → revise
         ↓ approved
Read writing-plans skill → create implementation plan
```

**The terminal state is reading the writing-plans skill.** The ONLY skill you invoke after brainstorming is writing-plans.
...
- Write the validated design (spec) to `data/<project-slug>/specs/YYYY-MM-DD-<topic>-design.md`
...
- Do NOT proceed to any other skill. writing-plans is the next step.
...
- `spec-document-reviewer-prompt.md` — Template for dispatching a spec reviewer task
